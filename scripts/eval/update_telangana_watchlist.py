...
NEW = [
    ...
    ("Rahul Gandhi", "%rahul gandhi%", "INC", "High command", "high_command", "core", "person"),
    ("Sonia Gandhi", "%sonia gandhi%", "INC", "High command", "high_command", "core", "person"),
    ("Priyanka Gandhi", "%priyanka gandhi%", "INC", "High command", "high_command", "core", "person"),
    ("Mallikarjun Kharge", "%mallikarjun kharge%", "INC", "AICC President", "high_command", "core", "person"),
    ...
    ("Narendra Modi", "%narendra modi%", "BJP", "Prime Minister", "centre", "core", "person"),
    ("Amit Shah", "%amit shah%", "BJP", "Home Minister", "centre", "core", "person"),
    ("Nirmala Sitharaman", "%nirmala sitharaman%", "BJP", "Finance Minister", "centre", "extended", "person"),
    ("Chandrababu Naidu", "%chandrababu naidu%", "TDP", "AP CM", "rival", "core", "person"),
    ("Y.S. Jagan Mohan Reddy", "%jagan mohan reddy%", "YSRCP", "ex-AP CM", "rival", "core", "person"),
