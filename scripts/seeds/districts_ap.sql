...
INSERT INTO districts (id, name, hq_city, centroid_lat, centroid_lon, state_code, aliases) VALUES
  ...
  ('guntur',                'GUNTUR',               'Guntur',          16.3067, 80.4365, 'AP', ARRAY[]::TEXT[]),
  ...
  ('kurnool',               'KURNOOL',              'Kurnool',         15.8281, 78.0373, 'AP', ARRAY[]::TEXT[]),
  ...
  ('srikakulam',            'SRIKAKULAM',           'Srikakulam',      18.2949, 83.8938, 'AP', ARRAY[]::TEXT[]),
  ...
  ('vizianagaram',          'VIZIANAGARAM',         'Vizianagaram',    18.1167, 83.4115, 'AP', ARRAY[]::TEXT[]),
