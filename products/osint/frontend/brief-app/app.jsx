...
const { Icon, Sparkline, MetricNumber, StanceDot, LanguagePill, LiveDot, Countdown, Reveal, SectionHead, ImageSlot, MethodPopover } = window.RIG;
const { SPARK, STORIES, ENTITIES, HORIZON, CLIMBING, BLINDSPOT, RECOMMENDED, nextRefreshAt } = window.RIG_DATA;
