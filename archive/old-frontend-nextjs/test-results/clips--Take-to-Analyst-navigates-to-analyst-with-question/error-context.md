...
- Name: clips.spec.ts >> "Take to Analyst" navigates to /analyst with question
- Location: e2e\clips.spec.ts:158:1
...
Call log:
  - waiting for getByRole('button', { name: /take to analyst/i })
