...
export default function InsightBomb({ insight, index = 0 }) {
  ...
  return (
    ...
    >
      ...
      {insight.evidence && (
        <p className="ib-evidence">{insight.evidence}</p>
      )}

      {insight.inference && (
        <p className="ib-inference">{insight.inference}</p>
      )}
      ...
      <div className="ib-footer">
        ...
        {insight.implication && (
          <p className="ib-implication">{insight.implication}</p>
        )}
      </div>
    </div>
  );
