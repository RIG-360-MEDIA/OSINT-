...
- Name: clips.spec.ts >> empty feed renders the "No clips on the wire" memo
- Location: e2e\clips.spec.ts:174:1
...
Locator: getByText(/No clips on the wire yet/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/No clips on the wire yet/i)
