...
const VOICES_DELETED = []; // MO-3: Voices Overnight removed; quotes migrated into STORIES[].principalQuote
...
const nextRefreshAt = Date.now() + REFRESH_INTERVAL_MS;

window.RIG_DATA = {
  SPARK, STORIES, ENTITIES, HORIZON, CLIMBING, BLINDSPOT, RECOMMENDED,
  REFRESH_INTERVAL_MS, nextRefreshAt,
};
