...
export const Icons = {
  ...
  chronicle: P(<><path d="M4 6h16M4 10h16M4 14h10" /><circle cx="17" cy="17" r="4" /><path d="M17 15v2l1 1" /></>),
  ask: P(<><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5Z" /></>),
};
