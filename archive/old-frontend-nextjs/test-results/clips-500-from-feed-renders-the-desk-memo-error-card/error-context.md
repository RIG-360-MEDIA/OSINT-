...
- Name: clips.spec.ts >> 500 from feed renders the desk-memo error card
- Location: e2e\clips.spec.ts:187:1
...
Locator: getByText(/feed is refusing to return/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/feed is refusing to return/i)
